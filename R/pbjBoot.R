...
#
pbjBoot = function(sqrtSigma, rboot=function(n){ (2*stats::rbinom(n, size=1, prob=0.5)-1)}, bootdim, method=c('wild', 'permutation', 'nonparametric'), h, sqrt_h, robust=TRUE, transform=c('none', 't')){
